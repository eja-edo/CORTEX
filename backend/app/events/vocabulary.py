...
EVENT_VOCABULARY: dict[str, EventVocabularyEntry] = {
    ...
    for e in [
        ...
        _entry("task.created", "A task was created", "app.services.tasks.TaskService"),
        _entry("task.updated", "A task changed (carries fields_changed)", "app.services.tasks.TaskService"),
        _entry("task.completed", "A task transitioned to done — published instead of task.updated for that transition", "app.services.tasks.TaskService"),
        _entry("task.deleted", "A task was deleted", "app.services.tasks.TaskService"),
        _entry("task.overdue", "A task transitioned into overdue (polled, not from a mutation)", "app.services.state_evaluator.StateEvaluator"),
